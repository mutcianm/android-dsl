...
fun typeFilter(str: String): String {
    when (str) {
        "java.lang.CharSequence" -> return "jet.CharSequence"
        "java.lang.String" -> return "jet.String"
        "java.lang.Integer" -> return "jet.Int"
        "java.lang.Object" -> return "jet.Any"
        else -> return str
    }
}
            ...
            Type.ARRAY -> {
                when (_type.getElementType()?.getSort()) {
                    ...
                    Type.LONG -> return "LongArray?"
                        ...
                        return "Array<" + typeFilter(typeStr(_type.getElementType(), nullable = false)) + ">?"
                    }
                }
            }
            else -> {
