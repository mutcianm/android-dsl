...
public class AndroidLayoutsTest extends BaseCompileTest {

    private final File testDataFile = new File("testdata/ru/ifmo/rain/adsl/tests/android/AndroidLayoutsTest.kt");
