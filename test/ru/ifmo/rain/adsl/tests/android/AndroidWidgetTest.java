...
public class AndroidWidgetTest extends BaseCompileTest {

    private final File testDataFile = new File("testdata/ru/ifmo/rain/adsl/tests/android/AndroidWidgetTest.kt");
